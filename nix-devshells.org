...
To start a development shell from a flake in the =/Users/jeff/devshells/rust= directory, pass the directory path to the call to src_shell[:exports code]{nix develop} command:
...
For projects I can't add flakes to, I use my own [[https://github.com/jeffkreeftmeijer/devshells][repository of development environments]][fn:repositories].
